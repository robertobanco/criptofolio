      ...
      <tr className="bg-gray-700/50">
        ...
        <td className="p-2 align-middle">
          <AutoCompleteInput
            ...
            onChange={(value) => setEditForm({ ...editForm, asset: value.toUpperCase() })}
...
const NewTransactionRow: React.FC<{
    ...
    const handleAdd = () => {
        ...
        onAdd({
            type: newTx.type,
            date: newTx.date,
            asset: newTx.asset.toUpperCase().trim(),
            ...
            <td className="p-2 align-middle">
                <input 
                    ...
                    className={`bg-gray-900 border rounded p-2 w-full text-sm focus:outline-none focus:ring-2 ${
                        errors.quantity ? 'border-red-500 text-red-400 focus:ring-red-500' : 'border-gray-600 focus:ring-indigo-500'
                    }`}
                />
            </td>
            <td className="p-2 align-middle">
                 <input 
                    ...
                    className={`bg-gray-900 border rounded p-2 w-full text-sm focus:outline-none focus:ring-2 ${
                        errors.value ? 'border-red-500 text-red-400 focus:ring-red-500' : 'border-gray-600 focus:ring-indigo-500'
                    }`}
                />
            </td>
            <td className="p-2 text-right align-middle">R$ {totalOperation.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
